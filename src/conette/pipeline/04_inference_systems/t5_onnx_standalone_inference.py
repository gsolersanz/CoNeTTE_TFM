...
"""
T5 ONNX INFERENCE CON TOKENIZER STANDALONE - VERSIÓN FINAL FUNCIONAL
====================================================================

Sistema optimizado que usa tokenizer standalone y preprocessing correcto.
PROBADO Y FUNCIONAL.
"""
...
class T5ONNXStandaloneInference:
    """Inference ONNX con tokenizer standalone - VERSIÓN FINAL."""
    ...
    def __init__(self,
        ...
        logger.info("🚀 Inicializando T5ONNXStandaloneInference")
        
        # Cargar tokenizer standalone (súper rápido)
        ...
        # Cargar preprocessor para formato correcto
        ...
        logger.info("✅ T5ONNXStandaloneInference inicializado")
    ...
    def _load_models(self, decoder_path: str, encoder_path: str, projection_path: str):
        ...
        # Cargar modelos
        self.decoder_session = ort.InferenceSession(decoder_path, providers=self.providers)
    ...
    def extract_features(self, processed_audio: np.ndarray) -> np.ndarray:
        """Extracción de features usando formato correcto."""
        
        # Encoder - usa el audio ya preprocesado en formato [batch, time, 768]
        # CRÍTICO: El encoder ONNX necesita tanto 'audio' como 'audio_shape'
        audio_shape = np.array([[processed_audio.shape[1]]], dtype=np.int64)  # [batch_size, 1] con longitud de audio
    ...
    def generate_caption(self, audio_features: np.ndarray) -> str:
        ...
        for step in range(self.max_length):
            ...
            for sequence, prev_sum_log_probs in beams:
                ...
                # Preparar inputs T5 - FORMATO CORRECTO
    ...
    def predict(self, audio_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            audio_features = self.extract_features(processed_audio)
...
def main():
    """Demo con tokenizer standalone FUNCIONAL."""
    
    logger.info("🎯 DEMO: T5 ONNX Standalone FUNCIONAL")
    logger.info("=" * 50)
    
    # Crear sistema
    system = T5ONNXStandaloneInference()
